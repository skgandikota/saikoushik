...
/**
 * Elementor WidgetKit Slider 1
 *
 * Elementor widget for WidgetKit slider 1
 *
 * @since 1.0.0
 */
class wkfe_slider_1 extends Widget_Base {

	public function get_name() {
		return 'widgetkit-for-elementor-slider-1';
	} 

	public function get_title() {
		return esc_html__( 'Slider Animation', 'widgetkit-for-elementor' );
	}
		      ...
		      [
		          ...
		          'default'     => [
		              [
		                ...
		                'btn-link' => 'https://themesgrove.com',
...
$this->start_controls_section(
	...
	$this->start_controls_tabs( 'caption_control' );
		...
		$this->add_responsive_control(
			'content_spacing',
				[
					'label'  => esc_html__( 'Slider Content Specing', 'widgetkit-for-elementor' ),
					...
					'selectors' => [
						'{{WRAPPER}}  .tgx-slider-1 .carousel .carousel-inner .carousel-caption .slider-description' => 'padding-top: {{SIZE}}{{UNIT}};',
					],
				]
			);
		...
		$this->add_control(
			'content_color',
				[
					'label'     => esc_html__( 'Slider Content Color', 'widgetkit-for-elementor' ),
					'type'      => Controls_Manager::COLOR,
					'default'   => '#fff',
					'selectors' => [
						'{{WRAPPER}}  .tgx-slider-1 .carousel .carousel-inner .carousel-caption .slider-description' => 'color: {{VALUE}};',
					],
				]
		);
		...
		$this->add_control(
			'item_overlay_color',
			[
				'label'     => esc_html__( 'Slider Item Overlay Bg Color', 'widgetkit-for-elementor' ),
				'type'      => Controls_Manager::COLOR,
				'default'   => 'rgba(7,16,38,0.83)',
				'selectors' => [
					'{{WRAPPER}} .tgx-slider-1 .carousel .carousel-inner .item:before' => 'background-color: {{VALUE}};',
					'{{WRAPPER}} .tgx-slider-1 .carousel .carousel-control:before' => 'background-color: {{VALUE}};',
				],
			]
		);
        ...
        $this->add_responsive_control(
			'desc_width',
				[
					...
					'selectors' => [
						'{{WRAPPER}} .tgx-slider-1 .carousel .carousel-inner .item .carousel-caption .slider-description' => 'width: {{SIZE}}{{UNIT}};',
					],
				]
			);
        ...
        $this->add_control(
			'content_margin',
				[
					...
					'selectors' => [
						'{{WRAPPER}} .tgx-slider-1 .carousel .carousel-inner .carousel-caption .slider-description' => 'margin: {{VALUE}};',
					],
				]
		);
        ...
        $this->add_control(
			'title_color',
				[
					'label'     => esc_html__( 'Slider Title Color', 'widgetkit-for-elementor' ),
					'type'      => Controls_Manager::COLOR,
					'default'   => '#fff',
					'selectors' => [
						'{{WRAPPER}} .tgx-slider-1 .carousel .carousel-inner .carousel-caption .slider-title' => 'color: {{VALUE}};',
					],
				]
		);
		...
		$this->add_control(
			'title_highlight',
				[
					...
					'default'   => '#ed485f',
					'selectors' => [
						'{{WRAPPER}} .tgx-slider-1 .carousel .carousel-inner .carousel-caption b,
						 {{WRAPPER}} .tgx-slider-1 .carousel .carousel-inner .carousel-caption span,
						 {{WRAPPER}} .tgx-slider-1 .carousel .carousel-inner .carousel-caption strong' => 'color: {{VALUE}};',
					],
				]
		);
        ...
        $this->add_responsive_control(
			'caption_position',
				[
					...
					'selectors' => [
						'{{WRAPPER}} .tgx-slider-1 .carousel .carousel-inner .item .carousel-caption' => 'top: {{SIZE}}{{UNIT}};',
					],
				]
			);
        ...
        $this->add_responsive_control(
			'caption_width',
				[
					...
					'selectors' => [
						'{{WRAPPER}} .tgx-slider-1 .carousel .carousel-inner .item .carousel-caption' => 'width: {{SIZE}}{{UNIT}};',
					],
				]
			);
		...
		$this->add_responsive_control(
	         'caption_align',
		         [
		           ...
		           'selectors' => [
		             '{{WRAPPER}} .tgx-slider-1 .carousel .carousel-inner .item .carousel-caption' => 'text-align: {{VALUE}};',
		           ],
	         ]
       );
...
// caption options End
	...
	$this->start_controls_section(
        ...
        $this->add_control(
            ...
            [
                ...
                'size_units' => [ 'px', '%' ],
                'selectors'  => [
                    '{{WRAPPER}} .tgx-slider-1 .carousel .carousel-inner .carousel-caption .btn-slider' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                ],
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'size_units' => [ 'px', 'em', '%' ],
                'selectors'  => [
                    '{{WRAPPER}} .tgx-slider-1 .carousel .carousel-inner .carousel-caption .btn-slider' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                ],
                'separator' => 'before',
            ]
        );
  ...
  //                   ],
		...
		// 			],
		// 			'selectors' => [
		// 				'{{WRAPPER}} .tgx-slider-1 .carousel .carousel-inner .carousel-caption .btn-slider' => 'font-size: {{SIZE}}{{UNIT}};',
		// 			],
		// 		]
		// 	);
  ...
  //      	$this->add_control(
		...
		// 		],
		// 		'selectors' => [
		// 			'{{WRAPPER}} .tgx-slider-1 .carousel .carousel-inner .carousel-caption .btn-slider' => 'text-transform: {{VALUE}};',
		// 		],
		// 	]
		// );
		...
		$this->add_responsive_control(
			'button_spacing',
				[
					...
					'selectors' => [
						'{{WRAPPER}} .tgx-slider-1 .carousel .carousel-inner .carousel-caption .btn-slider' => 'margin: {{SIZE}}{{UNIT}} 0;',
					],
				]
			);
    ...
    $this->add_control(
        'button_text_color',
          [
            ...
            'default'   => '#fff',
            'selectors' => [
              '{{WRAPPER}} .tgx-slider-1 .carousel .carousel-inner .carousel-caption .btn-slider' => 'color: {{VALUE}};',
            ],
          ]
    );
     ...
     $this->add_control(
        'button_border_color',
	        [
	            ...
	            'selectors' => [
	              '{{WRAPPER}} .tgx-slider-1 .carousel .carousel-inner .carousel-caption .btn-slider' => 'border: 1px solid {{VALUE}};',
	            ],
	        ]
        );
    ...
    $this->add_control(
        'hover_color',
		    [
		        ...
		        'default'   => ' #fff',
		        'selectors' => [
		          '{{WRAPPER}} .tgx-slider-1 .carousel .carousel-inner .carousel-caption .btn-slider:hover' => 'color: {{VALUE}};',
		        ],
		    ]
    );
    ...
    $this->add_control(
        'button_background_hover_color',
		    [
		        ...
		        'default'   => ' #ed485f',
		        'selectors' => [
		          '{{WRAPPER}} .tgx-slider-1 .carousel .carousel-inner .carousel-caption .btn-slider:hover' => 'background-color: {{VALUE}};',
		        ],
		    ]
    );
    ...
    $this->add_control(
        'button_hover_border_color',
	        [
	            ...
	            'default'   => ' #ed485f',
	            'selectors' => [
	              '{{WRAPPER}} .tgx-slider-1 .carousel .carousel-inner .carousel-caption .btn-slider:hover' => 'border-color: {{VALUE}};',
	            ],
	        ]
    );
...
$this->start_controls_section(
	...
	$this->start_controls_tabs( 'slider_control' );
		...
		$this->start_controls_tab(
	    	...
	    	$this->add_responsive_control(
				'slider_1_height',
					[
						...
						'selectors' => [
							'{{WRAPPER}} .tgx-slider-1 .carousel .carousel-inner .item' => 'height: {{SIZE}}{{UNIT}} !important;',
						],
					]
			);
			...
			$this->add_control(
				...
				[
					...
					'selectors' => [
						'{{WRAPPER}} .tgx-slider-1 .carousel .item' => 'background-repeat: {{VALUE}};',
					],
				]
			);
			...
			$this->add_control(
				...
				[
					...
					'selectors' => [
						'{{WRAPPER}} .tgx-slider-1 .carousel .item' => 'background-size: {{VALUE}};',
					],
				]
			);
			...
			$this->add_control(
				'bg_attachment',
				[
					'label'     => esc_html__( 'Bg Attachment', 'widgetkit-for-elementor' ),
					'type'      => Controls_Manager::SELECT,
					'default'   => 'scroll',
					'options'   => [
					...
					'selectors' => [
						'{{WRAPPER}} .tgx-slider-1 .carousel .item' => 'background-attachment: {{VALUE}};',
					],
				]
			);
    	...
    	$this->add_group_control(
			...
			[
				'name'  => 'slider_1_control_border',
				'label' => esc_html__( 'Border', 'widgetkit-for-elementor' ),
				'placeholder' => '1px',
				'default'     => '1px',
				'selector'    => '
				    {{WRAPPER}} .tgx-slider-1 .carousel .carousel-indicators li',
				    '{{WRAPPER}} .tgx-slider-1 .carousel .carousel-indicators li.active',
				'separator'   => 'before',
			]
		);

		$this->add_control(
			'slider_1_border_radius',
			[
				'label' => esc_html__( 'Border Radius', 'widgetkit-for-elementor' ),
				'type'  => Controls_Manager::DIMENSIONS,
				'size_units' => [ 'px', '%' ],
				'selectors'  => [
					'{{WRAPPER}} .tgx-slider-1 .carousel .carousel-control,
					 {{WRAPPER}} .tgx-slider-1 .carousel .carousel-indicators li,
					 {{WRAPPER}} .tgx-slider-1 .carousel .carousel-indicators li.active,
					 {{WRAPPER}} .tgx-slider-1 .carousel .carousel-indicators li.active:before' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				],
			]
		);
		...
		$this->add_control(
			'nav_color',
				[
					'label'     => esc_html__( 'Nav & Arrow Icon Color', 'widgetkit-for-elementor' ),
					'type'      => Controls_Manager::COLOR,
					'default'   => '#fff',
					'selectors' => [
						'{{WRAPPER}} .tgx-slider-1 .carousel .carousel-control i' => 'color: {{VALUE}};',
						'{{WRAPPER}} .tgx-slider-1 .carousel .carousel-control' => 'border:1px solid {{VALUE}};',
					],
				]
		);
		...
		$this->add_control(
			'nav_bg_color',
				[
					'label'     => esc_html__( 'Nav & Arrow Bg Color', 'widgetkit-for-elementor' ),
					'type'      => Controls_Manager::COLOR,
					'default'   => '#ed485f',
					'selectors' => [
						// '{{WRAPPER}} .tgx-slider-1 .carousel .carousel-indicators li.active' => 'border:1px solid {{VALUE}};',
						'{{WRAPPER}} .tgx-slider-1  .carousel-control:hover' => 'border-color: {{VALUE}} !important;',
						'{{WRAPPER}} .tgx-slider-1 .carousel .carousel-control:hover' => 'background-color:{{VALUE}};',
					],
				]
		);
